...
``docs/img/geometry/remeshing_performance.py`` on an NVIDIA RTX PRO 6000 Blackwell
...
.. image:: ../../img/geometry/remeshing_performance.png
...
.. automodule:: physicsnemo.geometry.remeshing
   :members:
   :show-inheritance:
